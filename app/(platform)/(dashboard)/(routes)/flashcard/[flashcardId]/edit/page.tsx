  ...
  return (
    <div className="bg-[#0a092d] min-h-screen text-white">
      <div className="flex justify-between p-4">
        {/* TODO: create back button para voltar */}
        <Link
          href="/estudo"
      ...
      <div className="max-w-4xl mx-auto p-4">
        ...
        <div className="flex gap-4 mb-8">
          ...
          <div className="ml-auto flex gap-2">
            <Button
              variant="outline"
              className="border-gray-700 bg-[#1e1d42] rounded-full p-2 h-10 w-10"
            >
            ...
            <div className="flex">
              <div className="w-1/2 p-6 border-r border-gray-700">
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-lg">
                    apresentação no formato de representação simulada (role
                    playing)
                  </p>
                  <div className="text-xs text-gray-500 uppercase mt-4">
                    TERMO
                  </div>
                </div>
              </div>
              ...
              <div className="w-1/2 p-6">
                <div className="space-y-4">
                  ...
                  <p>
                    Definição do Cenário: Identificar uma situação real ou
                    problema que precise ser abordado.
                  </p>
                  <p>
                    Atribuição de Papéis: Os participantes recebem papéis
                    específicos a desempenhar, geralmente baseados em
                    personagens ou situações reais.
                  </p>

                  <p className="text-lg">2. Execução</p>
                  <p>
                    Simulação: Os participantes atuam de acordo com seus papéis
                    em uma simulação controlada.
                  </p>
                  <p>
                    Interpretação e Improvisação: Eles devem reagir naturalmente
                    às situações apresentadas, permitindo a improvisação e o
                    desenvolvimento de habilidades.
                  </p>

                  <p className="text-lg">3. Feedback e Avaliação</p>
                  <p>
                    Análise do Desempenho: Após a simulação, os participantes
                    recebem feedback sobre seu desempenho.
                  </p>
                  <p>
                    Aprendizado e Melhoria: O feedback é usado para identificar
                    áreas de melhoria e desenvolver novas estratégias.
                  </p>
